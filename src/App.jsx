      ...
      <nav className={`navbar${scrolled ? ' scrolled' : ''}`}>
        <div className="nav-inner">
          ...
          <div className="nav-right">
            <a href="https://tudor-halasag.github.io/works" target="_blank" rel="noopener" className="works-btn">Works ↗</a>
...
<p>If you are looking for someone who hits the ground running and delivers — that is exactly what I do.</p>
  ...
  <div className="container footer-inner">
    ...
    <span className="footer-sep">·</span>
    <a href="https://tudor-halasag.github.io/works" target="_blank" rel="noopener" style={{color:'var(--accent)'}}>Works ↗</a>
  </div>
</footer>
    </div>
  )
