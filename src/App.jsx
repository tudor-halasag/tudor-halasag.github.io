...
const BLOG_POSTS = [
  ...
  {
    id: 3,
    title: 'Resume Polyglots vs. Real Fluency: The Modern Language Paradox',
    date: '2025-11-08',
    readTime: '4 min',
    tags: ['Language Learning', 'Communication', 'Career Insights'],
    summary: 'Listing three languages on a CV is easy. Actually speaking them is another matter entirely.',
    content: [
      'There was a time when speaking solid English was a standout resume feature that instantly set you apart. Today, it is barely the baseline. As the bar has risen, the corporate and social world has become obsessed with collecting languages like trading cards. It is increasingly common to meet people who claim to speak two, three, or even four languages. On paper, it sounds impressive. In practice, however, a frustrating gap has emerged between surface-level confidence and actual depth.',
      'We have all experienced working in international environments where someone lists high proficiency in English, only to get completely lost when a native speaker enters the room, uses idioms, or speaks at a natural pace. Misunderstandings happen, nuance gets stripped away, and communication breaks down. Knowing a few phrases or being able to order food in a restaurant is wonderful, but relying on superficial fluency in professional settings creates real friction.',
      'I was taught to approach language learning with respect for its depth — understanding its grammar, subtle layers, tone, and cultural context rather than just skimming the surface. As I prepare to take on my next language — whether that turns out to be German, Italian, or Spanish — I plan to apply that exact same philosophy. Mastery takes time, but truly understanding a language will always be worth more than simply adding another line to a resume.',
    ],
  },
  {
    id: 4,
    title: 'Strangers, Shared Rooms, and Soft Skills: The Real Value of Erasmus',
    date: '2025-07-09',
    readTime: '5 min',
    tags: ['Erasmus+', 'Personal Growth', 'Cultural Exchange'],
    summary: 'Fully funded, life-changing, and criminally underrated. Why every young person should chase an Erasmus opportunity.',
    content: [
      'We live in an extraordinary era for young people. Just a few decades ago, traveling across Europe, living alongside people from entirely different cultures, and gaining international experience was a privilege reserved for a select few. Today, fully funded youth exchanges and Erasmus projects have completely flipped that script. The fact that we can travel, learn, and grow — often at little to no cost — is something I refuse to take for granted.',
      'While academic settings teach you theory, Erasmus projects teach you real life. The true magic happens in the informal spaces: sharing a kitchen with five strangers from five different countries, navigating language barriers over dinner, and solving unexpected challenges together. You learn adaptivity, emotional intelligence, and non-verbal communication far faster in a week-long exchange than in months of traditional study. You come back not just with a certificate, but with a global mindset and a network of friends scattered across the continent.',
      'I am actively waiting for the next opportunity to open up. The moment a call for participants drops that aligns with my path, I am ready to jump on board — and I encourage anyone on the fence to do the exact same.',
    ],
  },
  {
    id: 5,
    ...
    <>
      ...
      <aside className={`sidebar${mobileOpen?' open':''}`}>
        ...
        <div className="sidebar-profile">
          ...
          <p className="sidebar-title">Robotics &amp; Industrial Engineering<br/>Transylvania University of Brașov</p>
      ...
      <main className="main-content">
        ...
        <section id="hero" className="hero">
          <div className="hero-inner">
            ...
            <p className="hero-title anim" style={{'--d':'0.35s'}}>Robotics &amp; Industrial Engineering — Transylvania University of Brașov</p>
          ...
          <div className="container">
            ...
            <div className="about-grid">
              <div className="about-body sf">
                ...
                <p>Robotics &amp; Industrial Engineering student at the Transylvania University of Brașov.</p>
                <p>I build across the entire stack — from C++ simulations and Python cryptographic tools down to custom-wired Arduino hardware and MATLAB system modeling.</p>
                <p>Every project you see here was built entirely outside the classroom out of pure curiosity and a desire to solve neat problems. That is how I approach engineering: hands-on, self-directed, and always building.</p>
                <div className="stats">
