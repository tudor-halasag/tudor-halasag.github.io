...
/* ─── DATA ──────────────────────────────────────────── */
const NAV_LINKS = ['about','experience','education','projects','skills','contact','verification']
...
<p>That is the kind of engineer I am — and this site is the evidence.</p>
          ...
          <div className="li-grid">
            <div className="li-card sf">
              ...
              <ul className="lang-list">
                {[{name:'Romanian',level:'Native',cls:'native'},{name:'English',level:'C2 — Cambridge Certificate',cls:'c2'},{name:'Italian',level:'A2 — Self-learning',cls:'a2'},{name:'Turkish',level:'A2 — Self-learning',cls:'a2'}].map(l=>(
      ...
      <section id="verification" className="section">
        <div className="container">
          <p className="sec-label sf">08 / Verification</p>
          ...
          <div className="verify-card sf">
            ...
            <div className="verify-channels">
              <div className="verify-item">
                <span className="verify-label">Official Email</span>
                <span className="verify-value">tudor.halasag@gmail.com</span>
                <span className="verify-note">The only email address I use for professional communication. Any other address is not me.</span>
              </div>
              <div className="verify-item">
                <span className="verify-label">LinkedIn</span>
                <a href="https://www.linkedin.com/in/tudor-halasag/" target="_blank" rel="noopener" className="verify-value verify-link">linkedin.com/in/tudor-halasag</a>
                <span className="verify-note">My only LinkedIn profile. Cross-check the URL exactly.</span>
              </div>
              <div className="verify-item">
                <span className="verify-label">GitHub</span>
                <a href="https://github.com/tudor-halasag" target="_blank" rel="noopener" className="verify-value verify-link">github.com/tudor-halasag</a>
                <span className="verify-note">My only GitHub account. All public projects are listed here.</span>
              </div>
              <div className="verify-item">
                <span className="verify-label">This Website</span>
                <span className="verify-value">tudor-halasag.github.io</span>
                <span className="verify-note">The only official portfolio website. Any other domain is not affiliated with me.</span>
              </div>
            </div>
