...
/* ─── DATA ──────────────────────────────────────────── */
const NAV_LINKS = ['about','experience','education','certifications','projects','skills','contact']
...
const CERTS = [
  {
    ...
    name:'Certificate of Proficiency in English — C1',
    detail:'Sat the C2 Proficiency exam (CPE) — the highest-level Cambridge English qualification. Achieved C1 with an overall score of 197/230, with C2-level performance in Speaking (222), Writing (209), and Use of English (209).',
    year:'2020',
    file:'cambridge.pdf',
  ...
  },
  {
    ...
    name:'Database Foundations — Award of Course Completion',
    detail:"Completed all coursework for Oracle Academy's Database Foundations programme, covering relational database concepts, SQL fundamentals, and data modelling principles.",
    year:'2021',
    file:'oracle.pdf',
    verify:null,
    refno:null,
  ...
  return (
    <div className="tl-card">
      <div className="tl-header">
        <div>
          <h3 className="tl-role">Barista &amp; Operations Lead</h3>
      ...
      <div className="expand-body" ref={ref}>
        <ul className="tl-bullets">
          <li>Directed high-volume retail operations with 100% cash-handling accuracy — managed ERP/POS data using Comax Smart Retail and Excel, supporting inventory tracking and financial reporting.</li>
          <li>Consistently optimised service workflow during peak hours, improving efficiency by 15–20% through disciplined preparation and process management.</li>
          <li>Trusted with shift leadership, team coordination, and full opening/closing responsibility — demonstrating operational reliability and management composure under pressure.</li>
        </ul>
      </div>
...
function CertCard({ c }) {
  ...
  return (
    <div className="cert-card sf">
      ...
      <div className="expand-body" ref={ref}>
        <p className="expand-text" style={{marginTop:'0.6rem'}}>{c.detail}</p>
        {c.refno && <p className="cert-ref">Ref: {c.refno}</p>}
      </div>
      <div className="cert-actions">
        ...
        <div className="cert-links">
          <a href={c.file} target="_blank" rel="noopener" className="github-btn">
            <DownloadIcon/> Certificate
          </a>
          {c.verify && (
            <a href={c.verify} target="_blank" rel="noopener" className="github-btn">
              🔗 Verify
            </a>
          )}
        </div>
  ...
  return (
    <div className={`mobile-menu${open ? ' open' : ''}`}>
      ...
      <div className="mobile-menu-inner">
        ...
        <a href="https://tudor-halasag.github.io/works" className="mobile-link works-mobile-link"
          style={{'--i': NAV_LINKS.length}} onClick={onClose}>
          Works
        </a>
      </div>
    </div>
...
/* ─── CONTACT FORM ──────────────────────────────────── */
/* ── EmailJS config ── replace the three values below with your own ── */
  ...
  return (
    <form onSubmit={handleSubmit} className="contact-form sf">
      ...
      <div className="form-group">
        ...
        <input type="email" id="cf-email" name="email" placeholder="your@email.com"
          value={formData.email} onChange={handleChange} required />
      </div>
      <div className="form-group">
        <label htmlFor="cf-msg">Message</label>
        <textarea id="cf-msg" name="message" rows={5} placeholder="What's on your mind?"
      ...
      <nav className={`navbar${scrolled ? ' scrolled' : ''}`}>
        <div className="nav-inner">
          ...
          <ul className="nav-links">
            ...
            <li><a href="https://tudor-halasag.github.io/works" className="nav-link works-nav-link">Works</a></li>
          </ul>
      ...
      <section id="hero" className="hero">
        <div className="hero-inner">
          ...
          <div className="hero-btns anim" style={{'--d':'0.65s'}}>
            ...
            <a href="https://www.linkedin.com/in/tudor-halasag/" target="_blank" rel="noopener" className="btn btn-outline"><LinkedInIcon/> LinkedIn</a>
            <a href="CV TUDOR ANDREI HĂLĂȘAG.pdf" download className="btn btn-outline"><DownloadIcon/> CV</a>
          </div>
        </div>
      </section>
...
<p>That is the kind of engineer I am — and this site is the evidence.</p>
              <div className="stats">
                {[['6+','Personal Projects'],['5+','Languages / Tools'],['C1','English Level']].map(([n,l])=>(
      ...
      <section id="certifications" className="section">
        <div className="container">
          <p className="sec-label sf">04 / Certifications</p>
          <h2 className="sec-heading sf">Certifications</h2>
          ...
          <div className="li-grid">
            <div className="li-card sf">
              ...
              <ul className="lang-list">
                {[{name:'Romanian',level:'Native',cls:'native'},{name:'English',level:'C1 — Cambridge CPE',cls:'c2'},{name:'Italian',level:'A2 — Self-learning',cls:'a2'},{name:'Turkish',level:'A2 — Self-learning',cls:'a2'}].map(l=>(
        ...
        <div className="container">
          ...
          <div className="contact-grid">
            <div className="contact-info sf">
              <p className="contact-blurb">If you're looking for an engineer who builds independently and delivers — the work is on this page. Reach out directly.</p>
